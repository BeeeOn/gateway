...
import HomeMaticModule
import NamedPipeModule
import TCModule
import time
import SensorData

class TestHomeMaticSwitch(HomeMaticModule.HomeMaticModule, TCModule.TCModule, NamedPipeModule.NamedPipeModule, GatewayBaseModule.GatewayBaseModule):

	def setUp(self):
		self.fhemuConfig['switch'] = True
		super().setUp()
	...
	def test_All(self):
		...
		commander.deviceSetValue(devices[0], "4", "1")
