...
class TestHomeMaticContact(HomeMaticModule.HomeMaticModule, TCModule.TCModule, NamedPipeModule.NamedPipeModule, GatewayBaseModule.GatewayBaseModule):

	def setUp(self):
		self.fhemuConfig['contact'] = True
		super().setUp()
