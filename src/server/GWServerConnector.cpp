...
BEEEON_OBJECT_PROPERTY("host", &GWServerConnector::setHost)
BEEEON_OBJECT_PROPERTY("port", &GWServerConnector::setPort)
BEEEON_OBJECT_PROPERTY("pollTimeout", &GWServerConnector::setPollTimeout)
BEEEON_OBJECT_PROPERTY("receiveTimeout", &GWServerConnector::setReceiveTimeout)
BEEEON_OBJECT_PROPERTY("sendTimeout", &GWServerConnector::setSendTimeout)
BEEEON_OBJECT_PROPERTY("retryConnectTimeout", &GWServerConnector::setRetryConnectTimeout)
BEEEON_OBJECT_PROPERTY("busySleep", &GWServerConnector::setBusySleep)
BEEEON_OBJECT_PROPERTY("resendTimeoutTimeout", &GWServerConnector::setResendTimeout)
BEEEON_OBJECT_PROPERTY("maxMessageSize", &GWServerConnector::setMaxMessageSize)
BEEEON_OBJECT_PROPERTY("inactiveMultiplier", &GWServerConnector::setInactiveMultiplier)
BEEEON_OBJECT_PROPERTY("sslConfig", &GWServerConnector::setSSLConfig)
BEEEON_OBJECT_PROPERTY("gatewayInfo", &GWServerConnector::setGatewayInfo)
BEEEON_OBJECT_PROPERTY("commandDispatcher", &GWServerConnector::setCommandDispatcher)
