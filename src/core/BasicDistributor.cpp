...
BEEEON_OBJECT_PROPERTY("exporters", &BasicDistributor::registerExporter)
BEEEON_OBJECT_PROPERTY("listeners", &BasicDistributor::registerListener)
BEEEON_OBJECT_PROPERTY("eventsExecutor", &BasicDistributor::setExecutor)
